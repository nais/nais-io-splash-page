...
import screenshotApps from '@/images/screenshots/apps.png'
import screenshotDatabase from '@/images/screenshots/database.png'
...
const features = [
  ...
  },
  {
    title: 'Overvåking',
    description:
      "Få oversikt over ytelsen til dine applikasjoner, og se hvor du kan forbedre dem. Få varsler om problemer før de påvirker brukerne.",
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Alt team trenger for å lage applikasjoner.
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Med nais kan teamene fokusere på å lage applikasjoner, ikke administrere infrastruktur.
          </p>
        </div>
        <TabGroup
