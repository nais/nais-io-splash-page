            ...
            <div className="max-w-2xl">
              <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
                ...
                {' '}<span className="relative whitespace-nowrap">
                  ...
                  <span className="relative">åpen kildekode</span>
                </span>{' '}
                .
              </h2>
              <p className="mt-4 text-lg text-slate-400">
                Nais plattformen er bygget på åpen kildekode som brukes av store teknologiselskaper over hele verden. Vi har valgt teknologier som er kjent for å være sikre, stabile og skalerbare.
              </p>
            </div>
