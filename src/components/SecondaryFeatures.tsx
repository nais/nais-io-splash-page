...
import screenshotVulnerabilities from '@/images/screenshots/vulnerabilities.png'
import screenshotGithub from '@/images/screenshots/github.png'
import screenshotTeam from '@/images/screenshots/team.png'
...
export function SecondaryFeatures() {
  return (
    <section
      ...
      aria-label="Funksjonalitet for å gjøre utvikling enklere"
